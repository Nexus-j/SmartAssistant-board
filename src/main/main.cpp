...
const char *wifiData[][2] = {
    {"K50Ultra", "123456789"}, // 替换为自己常用的wifi名和密码
    // {"222", "12345678"},
    // 继续添加需要的 Wi-Fi 名称和密码
};

String APPID = "809a34eb"; // 自己的星火大模型账号参数
String APIKey = "ac7af68acb52e95109c2bf3d387dcf23";
String APISecret = "NmI3N2FhNzQ1ZmNhMDY1M2EzNTRmMThj";
...
const char *appId1 = "809a34eb"; // 替换为自己的星火大模型参数
const char *domain1 = "generalv3.5";
const char *websockets_server = "ws://spark-api.xf-yun.com/v3.5/chat";
const char *websockets_server1 = "wss://iat-api.xfyun.cn/v2/iat";//"ws://ws-api.xfyun.cn/v2/iat";
using namespace websockets;
